...
struct MoreView: View {
    /**
     The model that stores the user selected settings for the app.
     */
        ...
        NavigationView {
            List {
                ...
                Section(header: Text("Resources")) {
                    Button(action: {
                        let url = URL(string: "https://apps.apple.com/us/app/horn-routines/id1513477348")!
                        UIApplication.shared.open(url)
                    }) {
                        HStack {
                            Image("HornRoutinesIcon")
